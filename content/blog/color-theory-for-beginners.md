---
{
  ...
  "longTailKeywords": [
    ...
    "why are the primary colors different on a screen"
  ],
  "aiSearchQuestions": [
    "What are hue, saturation and value?",
    "Why are the primary colours different for light and paint?",
  ...
  "faqs": [
    {
      "question": "What are hue, saturation and value?",
      "answer": "Hue is the name of the colour — red, orange, teal — and it is the property most people mean when they say \"colour\". Saturation, sometimes called chroma, is how pure or how grey that hue is. Value, sometimes called lightness, is how light or dark it is regardless of hue. Value is the one that does the most work in a picture, because it determines whether shapes read as separate when you glance at the image."
    },
    {
      "question": "Why are the primary colours different on a screen and on paper?",
      "answer": "Because they are doing opposite things. A screen emits light, and adding red, green and blue light together produces white — that is additive mixing. Ink and paint absorb light, so adding cyan, magenta and yellow together subtracts more and more until you approach black — that is subtractive mixing. The red-yellow-blue set taught in schools is a traditional approximation of subtractive mixing and is not accurate for either system."
    },
    {
      "question": "Why do my colours look muddy?",
      "answer": "Almost always because you mixed or placed hues from opposite sides of the wheel at similar saturation, or because everything in the picture sits at a similar value. Opposite hues neutralise each other toward grey, which is useful when you want it and murky when you do not. Similar values make shapes merge, so the image reads as one soft mass no matter how varied the hues are. Check the value spread first; it fixes more muddy pictures than changing hues does."
    },
    {
      "question": "What is a complementary colour scheme?",
      "answer": "Two hues from opposite sides of the colour wheel, used together. The pairing produces the strongest possible hue contrast, which is why it is used for accents and focal points and why it becomes exhausting when applied across a whole image at full saturation. The usual working method is to let one of the two dominate at low saturation and reserve the other for small, deliberate areas."
    },
    {
      "question": "Is there an easy way to practise this?",
      "answer": "Colouring existing line art is the cheapest way, because composition and drawing are already settled and only the colour decisions remain. Anime Coloring Book: Paint Art ships palettes spanning soft pastels, vibrant tones, classic shades, warm and cool sets, glow-inspired colours, chalk and glass-like textures, gradients and mosaics, so you can try the same drawing under several different schemes. It is free to download on Google Play, supported by ads, with optional in-app purchases."
    }
  ],
  "sources": [
    {
