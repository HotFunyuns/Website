---
{
  ...
  "secondaryKeywords": [
    ...
    "why do historical dates change",
    "what does circa mean in history"
  ],
  "intent": "informational",
  "longTailKeywords": [
    "how do archaeologists know how old something is",
    "what does calibrated radiocarbon date mean",
    "why is a radiocarbon date given as a range",
    "how accurate are ancient historical dates"
  ],
  "aiSearchQuestions": [
    "How do historians know when something happened?",
  ...
  "faqs": [
    {
      ...
      "answer": "Relative dating establishes order without numbers — this layer is below that one, so it was deposited earlier. Absolute dating attaches an actual figure, usually with a stated margin of uncertainty. In practice the two work together: relative sequences provide the structure, and a small number of absolute dates pin that structure to the calendar."
    },
    {
      "question": "How does radiocarbon dating work?",
      "answer": "Living things take up carbon from their environment, including the unstable isotope carbon-14. When an organism dies, uptake stops and the carbon-14 decays at a known rate, so the amount remaining indicates how long ago death occurred. Willard Libby received the 1960 Nobel Prize in Chemistry for the method. The raw measurement then has to be calibrated against a reference curve before it means anything in calendar years."
    },
    {
      "question": "Why is a radiocarbon date given as a range instead of a year?",
      "answer": "Because the relationship between measured radiocarbon and calendar years is not a straight line. Calibration programs such as OxCal convert a measurement using curves like IntCal20 and return a probability distribution, which is why published results appear as ranges quoted at a stated confidence level. A single year would misrepresent the certainty of the result."
    },
    {
      "question": "How precise can tree-ring dating be?",
      "answer": "Where conditions allow, dendrochronology can reach the individual year, because each ring corresponds to a growing season and the pattern of wide and narrow rings can be matched against a regional master chronology. That precision depends on having enough rings, a matching chronology for the region and species, and ideally the outermost ring preserved. The Laboratory of Tree-Ring Research at the University of Arizona, founded in 1937 by A.E. Douglass, remains a central institution for the method."
    },
    {
      "question": "Why do historians write 'circa' or 'conventionally dated to'?",
      "answer": "Because those phrases carry information. 'Circa' signals genuine uncertainty about the figure. 'Conventionally dated to' signals that a specific date is the agreed reference point among scholars rather than something proven from a single unambiguous record. Both are more honest than a bare number, and both tell you how much weight the date can bear."
    },
    {
      "question": "Does World History Timeline Sim show how its dates were established?",
      "answer": "It presents events on a timeline with era, region and category browsing, which is a format for orientation rather than a citation apparatus. Use it to get the sequence and the geography straight, then check anything you intend to rely on against an archive, museum record or published source that states its evidence."
    }
  ],
  "sources": [
    {
      "title": "The Nobel Prize in Chemistry 1960: Willard F. Libby",
      "publisher": "Nobel Prize Outreach",
      "url": "https://www.nobelprize.org/prizes/chemistry/1960/summary/",
      "accessed": "2026-08-09"
    },
    {
      "title": "OxCal: Radiocarbon Calibration",
      "publisher": "Oxford Radiocarbon Accelerator Unit, University of Oxford",
      "url": "https://c14.arch.ox.ac.uk/oxcal.html",
      "accessed": "2026-08-09"
    },
    {
      "title": "Oxford Radiocarbon Accelerator Unit",
      "publisher": "Research Laboratory for Archaeology and the History of Art, University of Oxford",
      "url": "https://c14.arch.ox.ac.uk/",
      "accessed": "2026-08-09"
    },
    {
      "title": "Laboratory of Tree-Ring Research",
...
We cover the calendar side of this in more depth in [how to actually learn something from a timeline](/blog/world-history-timeline-guide/), including why there is no year zero and why two sources can give different years for the same event without either being wrong.
...
1. **Calibration improves.** Radiocarbon calibration curves are periodically revised as more independently dated material is incorporated. A date published against an older curve may shift when recalculated.
2. **Better samples appear.** A date resting on charcoal from long-lived timber can be replaced by one resting on a seed from the same context, cutting out the old-wood gap.
3. **An inference is re-examined.** Many dates depend on chains — this layer relates to that structure, which relates to that record. Break or improve a link in the chain and everything attached to it moves.
