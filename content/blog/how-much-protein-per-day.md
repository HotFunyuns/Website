---
{
  ...
  "secondaryKeywords": [
    ...
    "acceptable macronutrient distribution range protein",
    "protein daily value 50 grams",
  ...
  "longTailKeywords": [
    ...
    "difference between rda and daily value for protein",
    "how much protein do athletes need per kg",
    "is there a tolerable upper intake level for protein"
  ],
  "aiSearchQuestions": [
    "How much protein should an adult eat per day?",
    "What is the RDA for protein in grams per kilogram?",
    "Why does the food label say 50 grams of protein?",
  ...
  "faqs": [
    {
      ...
      "answer": "That is a question for you and a qualified healthcare professional, because the answer depends on your body weight, age, health status, medication and activity. The published starting point is the Recommended Dietary Allowance of 0.8 grams of protein per kilogram of body weight per day for adults, set by the National Academies as the amount sufficient to meet the requirements of nearly all healthy people. It is designed to prevent deficiency, not to optimise anything."
    },
    {
      "question": "Why do I see 50 grams on food packaging instead?",
      "answer": "That is the FDA's Daily Value for protein used on Nutrition Facts labels, based on a 2,000 calorie reference diet. Daily Values exist so different products can be compared on one common scale, and the FDA states plainly that the reference diet may not match your own calorie needs. It is a labelling convention rather than a personal recommendation."
    },
    {
      "question": "Do athletes need more protein than the RDA?",
      "answer": "The NIH Office of Dietary Supplements notes that since the RDA was developed, more recent data have suggested athletes require a daily protein intake of 1.2 to 2.0 grams per kilogram of body weight to support metabolic adaptation, muscle repair and protein turnover. That is a published range from a federal health agency's review of the literature, not a prescription for any individual. Whether it applies to you is a conversation for a clinician or registered dietitian."
    },
    {
      "question": "Is there a maximum amount of protein I should eat?",
      "answer": "The Food and Nutrition Board did not set a Tolerable Upper Intake Level for protein, and the NIH Office of Dietary Supplements notes the board considered the risk of adverse effects from excess protein in food to be very low. The same source advises caution for people getting high intakes from foods plus supplements, because data on that combination is limited. The absence of an official upper limit is not the same as a statement that any amount is fine for everyone."
    },
    {
      "question": "How do I convert my weight into a protein figure?",
      "answer": "Divide your weight in pounds by 2.2046 to get kilograms, then multiply by the per-kilogram figure you are looking at. A person weighing 154 pounds is about 70 kilograms, so the 0.8 g/kg RDA works out at roughly 56 grams per day for them. Doing the arithmetic is easy; deciding which per-kilogram figure applies to you is the part that needs a professional."
    },
    {
      "question": "Does Protein Diet Tracker calculate a target for me?",
      "answer": "No. You set your own daily protein, calorie and macro goals and the app shows the day measured against the numbers you chose. It does not run a formula on your body and hand you a figure, which is deliberate — any app that does is applying an equation, not assessing you."
    }
  ],
  "sources": [
    {
    ...
    {
      "title": "Dietary Proteins",
      "publisher": "MedlinePlus, U.S. National Library of Medicine",
      "url": "https://medlineplus.gov/dietaryproteins.html",
      "accessed": "2026-08-09"
    },
    {
      "title": "DRI Calculator for Healthcare Professionals",
